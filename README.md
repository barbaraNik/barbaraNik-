...
# A Bit About Me | Немного обо мне
...
- ☕ Coffee enjoyer  
  Люблю кофе
- 🐈‍⬛ Have two black cats  
  У меня два чёрных кота
- 🧩 I like turning complex processes into simple and understandable systems  
  Люблю превращать сложные процессы в простые и понятные системы
